...
import { useMarketData, useEtfPrices, type EtfFeedState } from '@/lib/useMarketData'
...
export default function Page() {
  ...
  const etfFeedState = useEtfPrices(update)
  ...
  return (
    <div className={styles.app}>
      ...
      <div className={styles.layout}>
        <Sidebar state={state} update={update} regime={regime} carry={carry} R={R} isOpen={sidebarOpen} feedState={feedState} etfFeedState={etfFeedState} thetaState={thetaState} />
